...
export const fetchAlbumList = async ({ page = 1, pageSize = 20, ...other }:{page?:number, pageSize?:number, search?:string, artist?:string, order?:string}):Promise<ListResponseContainer<Album>> => {
